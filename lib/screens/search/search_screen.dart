...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Map<String, int> cartQuantities = {}; // Add cart quantities tracking
  ...
  // Cart controls widget - Same design as products.dart

  Widget _buildCartControls(dynamic product, int quantity) {
  if (quantity == 0) {
    return SizedBox(
      width: double.infinity,
      height: 36, // Increased height slightly
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: Colors.green.shade700,
          foregroundColor: Colors.white,
          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 0), // Added vertical padding control
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(8),
          ),
          minimumSize: const Size(0, 36), // Ensure minimum size
          tapTargetSize: MaterialTapTargetSize.shrinkWrap, // Reduce tap target padding
        ),
      ),
    );
  } else {
    return Container(
      height: 36, // Increased height to accommodate border
      decoration: BoxDecoration(
        ...
        child: Row(
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                width: 34, // Slightly increased width
                height: 34, // Fixed height instead of double.infinity
                decoration: BoxDecoration(
                  color: Colors.green.shade700,
                  borderRadius: const BorderRadius.only(
                ...
                child: const Center( // Added Center widget for better alignment
                  child: Icon(
                    Icons.remove,
                    color: Colors.white,
                    size: 14,
