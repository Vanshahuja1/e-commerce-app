...
class CartService {
  ...
  static Future<String?> _getUserId() async {
    final prefs = await SharedPreferences.getInstance();
    // First try to get the user_id directly
    String? userId = prefs.getString('user_id');
    
    // If not found, try to extract from user_data as fallback
    if (userId == null) {
  ...
  static Future<void> addToCart(Map<String, dynamic> product) async {
    try {
      ...
      print('Adding to cart - User ID: $userId, Token: ${token.substring(0, 10)}...'); // Debug log
      ...
      print('Cart add response: ${response.statusCode} - ${response.body}'); // Debug log
      ...
      print('Cart service error: $e'); // Debug log
